...
#View(results)
write.csv(results, paste0('simresults_um', '_', myseed, '_', sample_size, '_', number_of_sim, '_', format(Sys.time(), "%Y%m%d%H%M%S"), '.csv')
)
...
res1000 <- read.csv("simresults_um_125_1000_1000_20250331220848.csv")
res10000 <- read.csv("simresults_um_125_10000_1000_20250331223240.csv")
res100000 <- read.csv("simresults_um_125_100000_1000_20250331225909.csv")

res100000 <- read.csv("simresults_um_125_100000_1000_20250401002826_pnorm.csv")

res100000 <- read.csv("simresults_um_125_100000_1000_20250401003501_pnorm.csv")
...
boxplot(list(res100000$diff.logistic[!is.na(res100000$diff.logistic)],
             res100000$diff.logistic2[!is.na(res100000$diff.logistic2)],
             res100000$diff.logs2[!is.na(res100000$diff.logs2)]),
        horizontal=TRUE
)
mean(res100000$diff.logistic, na.rm=TRUE)
mean(res100000$diff.logistic2, na.rm=TRUE)
mean(res100000$diff.logs2, na.rm=TRUE)

sd(res100000$diff.logistic, na.rm=TRUE)
sd(res100000$diff.logistic2, na.rm=TRUE)
sd(res100000$diff.logs2, na.rm=TRUE)

mean(res100000$theor_gini_combined-res100000$gini_model_rho2, na.rm=TRUE)
mean(res100000$theor_gini_combined-res100000$gini_model_rho, na.rm=TRUE)
mean(res100000$theor_gini_combined-res100000$gini_model, na.rm=TRUE)
sd(res100000$theor_gini_combined-res100000$gini_model_rho2, na.rm=TRUE)
sd(res100000$theor_gini_combined-res100000$gini_model_rho, na.rm=TRUE)
...
mean(res100000$theor_gini_combined-res100000$gini_logs, na.rm=TRUE)
sd(res100000$theor_gini_combined-res100000$gini_logistic, na.rm=TRUE)
sd(res100000$theor_gini_combined-res100000$gini_logs, na.rm=TRUE)
