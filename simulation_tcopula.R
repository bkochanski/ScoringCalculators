...
for (i in 1:number_of_sim){
  ...
  z<-mvtnorm::rmvt(sample_size, sigma=sigma, df=4.5, delta=rep(0, 3),)
...
#View(results)
write.csv(results, paste0('simresults_um_t_', '_', myseed, '_', sample_size, '_', number_of_sim, '_', format(Sys.time(), "%Y%m%d%H%M%S"), '.csv')
)
...
res1000 <- read.csv("simresults_um_t__125_1000_1000_20250402193130.csv")
res10000 <- read.csv("simresults_um_t__125_10000_1000_20250402201043.csv")
res100000 <- read.csv("simresults_um_t__125_1e+05_1000_20250402195105.csv")
