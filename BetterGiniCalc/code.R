...
# In this example code we are using the binormal function:
...
better_gini_calculator<-function(GINI1=.45, GINI2=.65, B=.1, a0=.6, shape1=1, shape2=1){

  # setting binormal functions with GINI1 and GINI2 parameters
  y0<-function(x){FuncBiNormal(x,GINI1, shape1)}
  y1<-function(x){FuncBiNormal(x,GINI2, shape2)}
